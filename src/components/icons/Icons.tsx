...
// Base helper for standard SVG icon wrappers
const createIcon = (
  displayName: string,
...
export const CameraFlipIcon = createIcon(
  'CameraFlipIcon',
  <>
...
export const ScanCameraIcon = createIcon(
  'ScanCameraIcon',
  <>
...
export const FileExcelIcon = createIcon(
  'FileExcelIcon',
  <>
...
// ──── 5. Organization, Event & Badge Icons ────
export const YouthUnionIcon = createIcon(
  'YouthUnionIcon',
  <>
    {/* Stylized Youth Union torch and book shield */}
    <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" />
  </>
);

export const BadgeMedalIcon = createIcon(
  'BadgeMedalIcon',
  <>
